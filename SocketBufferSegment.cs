...
internal class SocketBufferSegment
{
	...
	private static SocketAsyncContext class10_0;
	...
	{
		AsyncSocketReader.smethod_4();
		object[] object_ = AsyncSocketReader.smethod_5();
		if (class10_0 == null)
		{
			class10_0 = new SocketAsyncContext(object_, hashtable_0);
		}
	}
}
