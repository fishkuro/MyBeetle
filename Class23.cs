...
internal class Class23
{
	...
	private static void smethod_7()
	{
		...
		Class7.int_0 = int.Parse(string_4[2]);
		class23_0.dateTime_1 = new DateTime(long.Parse(string_4[3]));
		Attribute1.bool_1 = class23_0.dateTime_1 > dateTime_0;
	}

	private static void smethod_8(string string_8, Class23 class23_1)
	{
		smethod_4(string_8);
	...
	public static Class23 smethod_12()
	{
		lock (typeof(Class23))
		{
			if (class23_0 == null)
			{
				...
				try
				{
					Class22.smethod_5(out string_6, out string_5);
					smethod_11(null);
					smethod_10(string_6);
					smethod_9();
		...
		Attribute1.bool_0 = class23_0.bool_0;
		return class23_0;
	}
	...
	public bool method_1(Action<Class45> action_0, Class45 class45_0, int int_1, out int int_2)
	{
		int_2 = method_0();
		if (bool_0)
		{
