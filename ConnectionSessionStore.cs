...
internal class ConnectionSessionStore : IChannel
{
	...
	internal HeartbeatMonitor class29_0;

	internal SocketAsyncControl class42_0;

	internal SocketAsyncControl class42_1;

	internal SocketAsyncControl class42_2;
	...
	private TransmissionController class34_0 = new TransmissionController();

	private AsyncWorkerScheduler class35_0 = new AsyncWorkerScheduler();
	...
	private static void smethod_0(ConnectionSessionStore class40_0)
	{
		lock (typeof(ConnectionSessionStore))
		{
			class40_0["_data"] = 255;
			long_0++;
	...
	public ConnectionSessionStore(Socket socket_1)
	{
		if (!TcpUtils.bool_0)
		{
		...
		idataWriter_0 = new MessageStream(TcpUtils.class7_0);
		((MessageStream)idataWriter_0).Channel = this;
		channelReceiveEventArgs_0.Channel = this;
		class29_0 = HeartbeatMonitor.smethod_1();
		bool_6 = true;
	}
	...
	private void method_5(IMessage imessage_0)
	{
		...
		method_8(((MessageStream)idataWriter_0).method_4());
	}
	...
	private void method_7(SessionIdentityBinder class43_0)
	{
	...
	internal void method_8(SessionIdentityBinder class43_0)
	{
		CommandAttribute attribute = null;
		try
		{
			...
			{
				TcpUtils.smethod_8();
				MessageReceivedEventArgs eventArgs = attribute.method_0();
	...
	private void method_13()
	{
		if (tcpServer_0 != null)
		{
			bool_9 = tcpServer_0.dictionary_1.Count > ClientTokenSession.int_0;
		}
	}
	...
	public bool Send<T, T1, T2>(ICallBackMessage icallBackMessage_0, EventCallBackHandler<T> callback, EventCallBackHandler<T1> callback1, EventCallBackHandler<T2> callback2, object usertoken = null) where T : ICallBackMessage where T1 : ICallBackMessage where T2 : ICallBackMessage
	{
		...
		ChannelMessageRouter @class = new ChannelMessageRouter();
