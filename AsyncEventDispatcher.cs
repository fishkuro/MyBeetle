...
internal class AsyncEventDispatcher
{
	private bool bool_0;
	...
	public AsyncEventDispatcher(PropertyInfo propertyInfo_1)
	{
		if (propertyInfo_1.CanWrite)
		{
			setValueHandler_0 = SocketSessionContext.smethod_4(propertyInfo_1);
		}
		if (propertyInfo_1.CanRead)
		{
			getValueHandler_0 = SocketSessionContext.smethod_6(propertyInfo_1);
		}
