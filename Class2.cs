...
internal abstract class Class2 : Package
{
	...
	public Class2(Class40 class40_0)
		: base(class40_0)
	{
	}
	...
	public override void MessageWrite(IMessage imessage_0, IDataWriter writer)
	{
		...
		WriteBlock writeBlock = ((Stream0)writer).WriteResultBlock(new byte[4], 0, 4, writeBlock_0);
