...
{
	private Queue<EventArgs0> queue_0;

	private EventArgs0 eventArgs0_0;
	...
	public Attribute9()
	{
		...
		queue_0 = new Queue<EventArgs0>(1024);
		base._002Ector();
	...
	public void method_0(EventArgs0 eventArgs0_1)
	{
		lock (queue_0)
		{
	...
	protected virtual void vmethod_0()
	{
		...
		if (eventArgs0_0 != null)
		{
			try
			{
				Class40 class40_ = eventArgs0_0.class40_0;
