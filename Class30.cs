...
internal class Class30
{
	...
	private static Class25 class25_0 = null;
		...
		lock (typeof(Class25))
		{
			if (class25_0 == null)
			{
				...
				try
				{
					...
					FieldInfo[] fields2 = typeof(Class42).GetFields(BindingFlags.Static | BindingFlags.Public);
					foreach (FieldInfo fieldInfo2 in fields2)
					{
						if (fieldInfo2.GetCustomAttributes(typeof(Attribute1), false).Length > 0)
						{
