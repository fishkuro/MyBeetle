...
internal class MessageStream : Stream, IDataWriter, IDataReader, IDataBlock
{
	...
	private SessionIdentityBinder class43_0 = new SessionIdentityBinder();
	...
	private ClientTokenSession class7_0;

	private CommandAttribute attribute1_0;

	private CommandAttribute attribute1_1;
	...
	internal MessageStream(ClientTokenSession class7_1)
	{
		bool_0 = true;
		class7_0 = class7_1;
		method_0();
	...
	{
		CommandAttribute attribute = class7_0.method_2();
	...
	internal static string smethod_3()
	{
		try
		{
			string path = TcpUtils.smethod_0() + MessageReceivedEventArgs.smethod_1();
	...
	internal static string smethod_4()
	{
		try
		{
			string text = MessageReceivedEventArgs.smethod_0();
			if (MessageReceivedEventArgs.smethod_2(text))
			{
	...
	public IList<ByteArraySegment> GetBlock(int count)
	{
		...
		CommandAttribute attribute = attribute1_1;
		if (attribute != null)
		{
	...
	internal SessionIdentityBinder method_4()
	{
	...
	public long ReadLong()
	{
		...
		if (!bool_0)
		{
			result = DataSegmentPool.smethod_4(result);
		}
		return result;
	}
	...
	public int method_7()
	{
		...
		if (attribute1_1 != null)
		{
			...
			for (CommandAttribute attribute = attribute1_1.attribute1_0; attribute != null; attribute = attribute.attribute1_0)
			{
				num += attribute.int_2;
			}
		}
