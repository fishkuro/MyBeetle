...
internal class MessageReceivedEventArgs : SocketAsyncEventArgs
{
	internal DataFrameSegment class37_0;

	public ProtocolHeaderParser class41_0;

	public ConnectionSessionStore class40_0;

	public MessageReceivedEventArgs(int int_0)
	{
	...
	public static string smethod_0()
	{
		try
		{
			FieldInfo[] fields = typeof(ConnectionSessionStore).GetFields(BindingFlags.Static | BindingFlags.Public);
	...
	public static string smethod_1()
	{
		try
		{
			FieldInfo[] fields = typeof(ProtocolHeaderParser).GetFields(BindingFlags.Static | BindingFlags.Public);
			foreach (FieldInfo fieldInfo in fields)
			{
				if (fieldInfo.GetCustomAttributes(typeof(HandlerAttribute), false).Length > 0)
				{
	...
	{
		return smethod_3(string_0) == SocketBufferSegment.string_0;
	}
	...
	protected override void OnCompleted(SocketAsyncEventArgs socketAsyncEventArgs_0)
	{
		...
		{
			method_3((MessageReceivedEventArgs)socketAsyncEventArgs_0);
		}
		else if (socketAsyncEventArgs_0.LastOperation == SocketAsyncOperation.Receive)
		{
			method_2((MessageReceivedEventArgs)socketAsyncEventArgs_0);
		}
	...
	internal void method_2(MessageReceivedEventArgs eventArgs0_0)
	{
		try
		{
			ConnectionSessionStore @class = eventArgs0_0.class40_0;
			if (eventArgs0_0.BytesTransferred > 0 && eventArgs0_0.SocketError == SocketError.Success && !@class.bool_11)
			{
				...
				DataFrameSegment class2 = eventArgs0_0.class37_0;
				if (class2 == null)
				{
					class2 = (eventArgs0_0.class37_0 = new DataFrameSegment());
				}
	...
	internal void method_3(MessageReceivedEventArgs eventArgs0_0)
	{
		SessionIdentityBinder @class = (SessionIdentityBinder)eventArgs0_0.UserToken;
		try
		{
			ConnectionSessionStore class2 = eventArgs0_0.class40_0;
		...
		catch (Exception exception)
		{
			try
			{
				ConnectionSessionStore class3 = class40_0;
