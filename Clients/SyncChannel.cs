...
namespace Beetle.Clients
{
	public class SyncChannel<T> : ISyncChannel where T : Package, new()
	{
		...
		private MessageStream stream0_0;
		...
		protected virtual void OnInit()
		{
			...
			stream0_0 = new MessageStream(TcpUtils.class7_0);
		...
		private void method_2(SessionIdentityBinder class43_0)
		{
			try
			{
				int num = 0;
				...
				{
					CommandAttribute attribute1_ = class43_0.attribute1_0;
					num = 0;
